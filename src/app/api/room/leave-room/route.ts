...
export async function POST(req: Request) {
    ...
    try {
        ...
        const room = await Room.findByIdAndUpdate(payload.id, { $pull: { members: payload.userId } }, { new: true }).lean();
        return NextResponse.json({ success: true, msg: "Succesfully Exited", data: room })
    } catch (e) {
